...
if st.button("결과 보기"):
    ...
    st.markdown(gradient_bar(0, 200, rdi, rdi_ranges, rdi_colors, ['정상','경도','중등도','중증']), unsafe_allow_html=True)
    ...
    st.markdown(gradient_bar(0, 200, o2, o2_ranges, o2_colors, ['저하','위험','경계','정상']), unsafe_allow_html=True)
